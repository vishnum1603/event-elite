...
import img from "../../assets/images/conformance.jpg";
    ...
    <div>
      ...
      <div className="confirmation-container">
        <div className="image-container">
          <img src={img} alt={packageData.title} className="confirmation-image" />
        </div>
        <div className="details-container">
          <h2 className="title">{packageData.title}</h2>
          <p className="text">Venue: {packageData.venue}</p>
          <p className="text">Capacity: {packageData.capacity}</p>
          ...
          <div className="date-picker-container">
            ...
            {availability !== null && (
              <span className="availability-icon">
                {availability ? <CheckCircle style={{ color: "green" }} /> : <Cancel style={{ color: "red" }} />}
              </span>
            )}
          </div>
